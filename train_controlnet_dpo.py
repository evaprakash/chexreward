...
from transformers import AutoTokenizer, PretrainedConfig, AutoModelForMaskedLM
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=77,
        help="Maximum length for tokenizer. Defaults to 77.",
    )
    parser.add_argument(
        "--validation_steps",
        type=int,
...
def make_train_dataset(args, tokenizer, accelerator):
    ...
    def tokenize_captions(examples, is_train=True):
        ...
        inputs = tokenizer(
            captions[0], max_length=args.max_length, padding="max_length", truncation=True, return_tensors="pt"
        )
    ...
    def preprocess_train(examples):
        ...
        for image in examples[conditioning_image_column]:
            if image == "N/A":
                conditioning_images.append(Image.new("RGB", (512, 512)))
            else:
