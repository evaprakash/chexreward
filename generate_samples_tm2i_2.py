...
with open('prompt_dicom_pairs_2.csv', 'w', newline='') as file:
...
for ex in range(len(prompt_dicom_pairs)):
    ...
    for info in [(image_id_1, conditioning_image_1), (image_id_2, conditioning_image_2)]:
        ...
        for i in range(num_samples):
            ...
            image.save("tm2i_samples_2/" + image_id + "_" + str(i + 1) + ".jpg")
            conditioning_image.save("tm2i_samples_2/" + image_id + "_mask_" + str(i + 1) + ".jpg")
