        ...
        for step, batch_data_package in enumerate(train_loader):
            ...
            if (iterations % opts.accumulation_steps) == 0:
                ...
                if get_rank() == 0:
                    ...
                    with open("log.txt", "a") as fp:
                        fp.write("Iteration, loss, acc: " + str(train_iteration) +  ", " + str(torch.mean(losses_log)) + ", " + str(sum(acc_list)/len(acc_list)) + "\n")
            ...
            if (iterations % steps_per_valid) == 0:
                if get_rank() == 0:
                    ...
                    with open("log.txt", "a") as fp:
                        fp.write("Validation - iteration, loss, acc: " + str(train_iteration) +  ", " + str(torch.mean(valid_loss)) + ", " + str(sum(valid_acc_list)/len(valid_acc_list)) + "\n")
