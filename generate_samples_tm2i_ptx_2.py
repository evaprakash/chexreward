...
images, prompts = load_and_filter_csv('ptx_prompt_2.csv', prefix)
...
for ex in range(len(images)):
    ...
    for i in range(num_samples):
        ...
        image.save("tm2i_samples_ptx_2/" + image_id + "_" + task_id + "_" +  str(i + 1) + ".jpg")
        conditioning_image.save("tm2i_samples_ptx_2/" + image_id + "_" + task_id + "_mask_" + str(i + 1) + ".jpg")
